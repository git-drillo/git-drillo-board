...
class BoardPageContainer extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      inProgress: [
        { task: 'Create login button', tag: 'frontend', assignedDev: 'none', userId: '7bc', commitMessage: 'done with button creation', commitUrl: 'http://github/foo/bar', pending: false },
      ],
      done: [
        { task: 'Create login button', tag: 'frontend', assignedDev: 'none', userId: '7bc', commitMessage: 'done with button creation', commitUrl: 'http://github/foo/bar', pending: true },
        { task: 'Create login button', tag: 'frontend', assignedDev: 'none', userId: '7bc', commitMessage: 'done with button creation', commitUrl: 'http://github/foo/bar', pending: false }, { task: 'Create login button', tag: 'frontend', assignedDev: 'none', userId: '7bc', commitMessage: 'done with button creation', commitUrl: 'http://github/foo/bar', pending: true },
      ],
    };
  }
